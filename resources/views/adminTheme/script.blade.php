...
<script src="{{ asset('adminTheme/app-assets/vendors/js/charts/apexcharts.min.js') }}"></script>
...
<!-- BEGIN: Page JS-->
<script src="{{ asset('adminTheme/app-assets/js/scripts/pages/dashboard-ecommerce.js') }}"></script>
<!-- END: Page JS-->
