...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        ...
                        <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="{{ asset('adminTheme/app-assets/images/pages/forgot-password-v2.svg') }}" alt="Forgot password V2" /></div>
                        </div>
                        <!-- /Left Text-->
                        <!-- Forgot password-->
                            ...
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                ...
                                <form class="auth-forgot-password-form mt-2" action="{{ route('admin.forget.password.post') }}" method="POST">
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <input class="form-control" id="email" type="text" name="email" placeholder="enter your email" aria-describedby="forgot-password-email" autofocus="" tabindex="1" />
                                    </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ asset('adminTheme/app-assets/js/scripts/pages/auth-forgot-password.js') }}"></script>
    <!-- END: Page JS-->
